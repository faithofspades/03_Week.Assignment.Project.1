...
class Song {
    constructor(title, artist, album) {
        this.title = title;
        this.artist = artist; // Directly assign the Musician object
        this.album = album;
    }
}
...
//3. Declare a class called Playlist, it's constructor should take four parameters: name, song1, song2, song3
class Playlist {
